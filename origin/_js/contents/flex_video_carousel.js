...
$(function () {
	...
	// ### カルーセル
	// カルーセル設定
	var visual = new Swiper('#flexVideoSwiper', { //対象カルーセルのidを指定（.swiper-container にid付与）
		navigation: {
			nextEl: '.flexVideoNext', //次へのボタン要素名
			prevEl: '.flexVideoPrev' //前へのボタン要素名
		},
		pagination: {
		...
		spaceBetween: 30,
		// loop: true,
		loopedSlides: 4, // コンテンツの数＋2 の数字を指定（指定が漏れると、ループの最後のリンクが反応しなくなる事が多い）
		autoplay: {
			delay: 3000
		},
		breakpoints: {
